                ...
                <div class="bg-light p-4 mb-30">
                    <form id="filter-form" action="{{ route('products') }}" method="GET">
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" name="all_category" id="price-all">
                        ...
                        @foreach ($category as $_category)
                            <div
                                ...
                                <input type="checkbox" class="custom-control-input" name="category[]"
                                    id="price-{{ $loop->index }}" value="{{ $_category->id }}">
                                <label class="custom-control-label"
                                    for="price-{{ $loop->index }}">{{ $_category->name }}</label>
                                <span class="badge border font-weight-normal">{{ $_category->products_count }}</span>
                            </div>
                        @endforeach
                            ...
                            <div class="product-item bg-light mb-4 bg-radius">
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <h5>{{ $product->discount_price }} VND</h5>
                                        <h6 class="text-muted ml-2"><del>{{ $product->selling_price }} VND</del></h6>
                                    </div>
