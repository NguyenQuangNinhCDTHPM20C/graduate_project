                            ...
                            <div class="account-form">
                                <form onsubmit="return validFormAccount(this);">
                                    <div class="form-controls">
                                        <label>Họ tên:</label>
                                        <div class="controls">
                                            <input type="text" value="{{ session('account')->name }}" name="Title"
                                                id="Title" placeholder="Họ tên *" data-required="1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-controls">
                                        ...
                                        <div class="controls">
                                            <input type="tel" value="{{ session('account')->phone_number }}"
                                                name="PhoneNumber" id="PhoneNumber" placeholder="Điện thoại *"
                                                data-required="1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-controls">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="{{ session('account')->address }}" name="Address"
                                                id="Address" placeholder="Địa chỉ *" data-required="1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-controls">
                                        ...
                                        <div class="controls">
                                            <select id="SystemDistrictID" name="SystemDistrictID"
                                                placeholder="Quận/Huyện *" data-required="1">
                                    ...
                                    <div class="acc">
                                        <form method="post" action="/Account/LinkLogin">
                                            ...
                                            <p>
                                                ...
                                                <strong>{{ !empty(session('account')->facebook_id) ? 'Đã liên kết' : 'Chưa liên kết' }}</strong>
                                            </p>
                                            @if (!session('account')->facebook_id)
                                                <button class="btn-extlogin btn-facebook"
                                                    title="Liên kết tài khoản Facebook" type="submit" id="Facebook"
                                        ...
                                        <form method="post" action="/Account/LinkLogin">
                                            ...
                                            @if (!session('account')->google_id)
                                                <button class="btn-extlogin btn-google" type="submit"
                                                    title="Đăng nhập qua Google+" id="Google" name="provider"
                                                    value="Google">
