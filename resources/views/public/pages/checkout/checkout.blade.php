                ...
                <div class="bg-light p-30 mb-5 bg-radius">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Name</label>
                            <input class="form-control" type="text" placeholder="Ninh Nguyen"
                        ...
                        <div class="col-md-6 form-group">
                            <label>Address</label>
                            <input class="form-control" type="text" placeholder="65 Huynh Thuc Khang"
                                value="{{ session()->has('account') ? session('account')->address : '' }}">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Country</label>
                        ...
                        <div class="col-md-6 form-group">
                            <label>Town</label>
                            <input class="form-control" type="text" placeholder="Dictrit 1">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>City</label>
                            <input class="form-control" type="text" placeholder="Ho Chi Minh">
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="directcheck"> <img style="width:30%;"
                                        src="{{ asset('images/Ship_COD.jpg') }}" alt="Check out with PayPal"></label>
                            </div>
                        </div>
                        @php
