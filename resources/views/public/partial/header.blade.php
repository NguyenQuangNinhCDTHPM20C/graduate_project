  ...
  <div class="container-fluid">
      <div class="row bg-secondary py-1 px-xl-5">
          ...
          <div class="col-lg-6 text-center text-lg-right">
              <div class="d-inline-flex align-items-center">
                  <div class="btn-group">
                      <a class="text-body" href="">Login</a>
      ...
      <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
          <div class="col-lg-4">
              <a href="" class="logo">
                  <img src="images/logoshop.png" style="  width: 35%;
        padding-right: 10px;
        object-fit: cover;" alt="CÔNG TY CỔ PHẦN XÂY DỰNG VÀ ĐẦU TƯ THƯƠNG MẠI HOÀNG HÀ">
              </a>
          </div>
  ...
  <div class="container-fluid bg-dark mb-30">
      <div class="row px-xl-5">
          <div class="col-lg-3 d-none d-lg-block bg-category">
              <a class="btn d-flex align-items-center justify-content-between bg-primary bg-category w-100"
