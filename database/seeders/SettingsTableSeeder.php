...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $settings = [
            ...
            frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>', 'link_facebook' => 'https://www.facebook.com/caothang.edu.vn/' ,'link_twitter' => 'https://www.facebook.com/caothang.edu.vn/', 'logo' => 'images/logoshop1.png', 'favicon' => 'images/doublenshop-favicon.png']];
