$(document).ready(function () {
    $.fn.showConfirmationDeleteAlert = function (formId) {
        Swal.fire({
            title: "Bạn chắc chứ?",
            text: "Bạn sẽ không thể hoàn tác vụ này!",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
            confirmButtonText: "Đúng, xóa phần tử này!",
            confirmButtonClass: "btn btn-primary",
            cancelButtonClass: "btn btn-danger ml-1",
            buttonsStyling: false,
        }).then(function (result) {
            if (result.value) {
                // Nếu người dùng nhấp vào nút "Yes"
                // Thực hiện submit form
                $("#" + formId).submit();

                // Hiển thị cảnh báo "Deleted!"
                Swal.fire({
                    type: "success",
                    title: "Xóa thành công!",
                    text: "Phần tử đã được xóa",
